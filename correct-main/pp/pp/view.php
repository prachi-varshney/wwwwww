            ...
            <div class="row">
                ...
                <!-- <div class="mb-3 col-md-3">
                    ...
                    <select class="form-select form-select-sm selectpicker" name="state" id="state">
                        ...
                        //         echo "<option id=' {$value["state_id"]} '> {$value['state_name']} </option>";
                        //     }
                        // }
                ...
                <div class="mb-3 col-md-3">
                    ...
                    <select class="form-select form-select-sm selectpicker" name="city" id="city" required>
                        <option value="">Select </option>
                    </select>
                </div>
 -->
...
<div class="mb-3 col-md-3">
    ...
    <select class="form-select form-select-sm selectpicker" name="district" id="district" required>
        <option value="">Select </option>
    </select>
</div>
                ...
                <div class="mb-3 col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" maxlength="6" name="pincode" id="pincode"
                        required />
                </div>
                <div class="mb-3 col-md-3">
                ...
                <div class="mb-3 col-md-3">
                    ...
                    <div id="otherHobbyInput" style="display: none;">
                        <input type="text" class="form-control form-control-sm mt-2" id="otherHobby" name="hobbies[]"
