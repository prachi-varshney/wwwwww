...
function addEditForm() {
    ...
    $query = "INSERT INTO empp (name, email, phone_no, dob, experience, salary, state, districts, pincode, bio, address, gender, hobbies) 
              VALUES ('$name', '$email', '$phone_no', '$dob', '$experience', '$salary', '$state', '$districts', '$pincode', '$bio', '$address', '$gender', '$hobbies')";
